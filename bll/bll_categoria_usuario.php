...
if ($acao === 'inserir') {
    ...
    if ($dao_categoria_usuario->inserir($vo_categoria_usuario)) {
        $retorno = $vo_categoria_usuario->get_id_categoria_usuario() ? trim($vo_categoria_usuario->get_id_categoria_usuario()) : null;
    }
    ...
    if ($vo_categoria_usuario) {
        foreach ($vo_categoria_usuario as $temp) {
            array_push($retorno, array(
                'id_categoria_usuario' => $temp->get_id_categoria_usuario() ? trim($temp->get_id_categoria_usuario()) : null,
